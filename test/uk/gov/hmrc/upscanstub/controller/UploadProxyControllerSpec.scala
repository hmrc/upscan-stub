...
import uk.gov.hmrc.upscanstub.controller.UploadProxyController.ErrorAction
import uk.gov.hmrc.upscanstub.controller.UploadProxyController.ErrorResponseHandler.proxyErrorResponse
